<template>
  <main>
    <div id="podcasts" class="podcasts_block">
      <podcastItem v-for="podcast in PODCASTS" :key="podcast.id" v-bind="podcast"/>
    ...
    <div id="blogs" class="blogs_block">
      ...
      <div class="blogs_inner-desk" v-if="$mq === 'lg'">
        <blogItem v-for="post in POSTS" v-bind="post" :key="post.id" class="blogs_item-desk" />
      </div>
      ...
      >
        <Slide v-for="post in POSTS" :key="post.id">
          <blogItem v-bind="post" class="blogs_item-mob" />
        </Slide>
      </Hooper>
    </div>
